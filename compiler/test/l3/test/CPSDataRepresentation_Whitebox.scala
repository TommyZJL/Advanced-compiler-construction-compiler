...
class CPSDataRepresentation_Whitebox_Cond extends CPSLowTest {

  // Starting this "Data representation" assignment, we will not have whitebox
  ...
  @Test def testDataReprOnePlusTwo =
    testCPSLowTreeEquality("(@ + 1 2)",
      "(let* ((v$1 3) (v$2 5) (v$3 (+ v$1 v$2)) (v$4 1) (v$5 (- v$3 v$4))) (halt))")
}
