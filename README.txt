...
==============
  ...
  Welcome to the L₃ project, composed of an L₃ compiler, a virtual
  machine, a library and a few example programs. The directories are
  laid out as follows:
  ...
  Most of these directories contain a `README' file with further
  information.
